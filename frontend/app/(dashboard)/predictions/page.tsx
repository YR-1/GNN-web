                            ...
                            >
                              <div className='mb-1.5 flex items-start justify-between gap-3'>
                                <div className='min-w-0'>
                                  <div className='flex items-center gap-2'>
                                    <p className='font-display truncate text-[14px] font-bold text-slate-900'>{score.name}</p>
                                    <span
                                      className='inline-flex h-[18px] w-[18px] items-center justify-center rounded-full border border-slate-300 bg-slate-100 text-slate-500'
